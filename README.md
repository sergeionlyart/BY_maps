...
## Прогноз населения 2026–2075 (v2026.2)
...
когортные модели). Три сценария; 80% интервал для уровней 0–1. На карте —
слайдер за 2026 год работает на всех уровнях (переключатель сценариев,
тултипы с версией и сценарием).
...
2,76%; бэктест городов — 6,7% против 10,9%. Отчёт —
[docs/notes/validation.md](docs/notes/validation.md); пакет —
`by-maps-forecast-v1.1.0.zip`.
