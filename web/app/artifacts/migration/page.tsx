  ...
  return (
    <div className="page">
      <div className="page-breadcrumb">
        <Link href="/artifacts">Артефакты</Link> · INF-05
      </div>
      <h1>Пакет: Внутренняя и внешняя миграция</h1>
      <p className="page-lead">
        Сальдо миграции 128 территорий (1994–2019 + 2024–2025; 2020–2023
        Белстат не публиковал), ярусы расселения 1959–2026, межобластная
        матрица переписи-2019 и внешняя волна 2020+ интервалами: сток ВНЖ
        ЕС по странам, интервал WP-F3, точечные оценки со снапшотами.
        Конвейер стартует с сырых ответов API; расчёт детерминирован.
      </p>

      <h2>Версии</h2>
      <div className="card">
        <div className="card-code">v1.0.0 · 2026-07-12 · git-тег artifact-migration-v1.0.0</div>
        <p>
          Первый релиз. Контраст официального (+13,9 тыс. в 2019) и
          зеркального рядов (сток ВНЖ ЕС 133,9 → 386,8 тыс. за 2019–2024;
          интервал неучтённого оттока 178–416 тыс.); лестница: село −65%
          с 1959, Минск ×3,9, единственный нетто-магнит матрицы.
          17 контрольных метрик.
        </p>
...
# Все 17 контрольных метрик воспроизведены в допусках.`}</code></pre>
      ...
      <p className="hint">
        Живая версия — <Link href="/research/migration">/research/migration</Link>;
