...
export const RESEARCH: ResearchEntry[] = [
  ...
  /* INF-13 BEGIN */
  {
    slug: 'pension',
    code: 'INF-13',
    title: 'Кто кого содержит: коэффициент поддержки по районам',
    question:
      'Сколько работающих (по годовой законной границе трудоспособного возраста, не по константе) приходится на одного человека старше трудоспособного возраста — в каждом из 118 районов Беларуси, 1989–2056 — и в каком году район проходит пороги 3:1, 1,5:1, 1:1? Как это меняется при трёх сценариях, двух стартовых рядах и трёх вариантах пенсионного возраста?',
    status: 'published',
    stage: 9,
    artifact: { file: 'by-maps-pension-v1.0.0.zip', version: '1.0.0', sizeKb: 4280 },
  },
  /* INF-13 END */
  /* INF-15 BEGIN */
  {
    slug: 'grid',
    code: 'INF-15',
    title: 'Полотно: карта расселения Беларуси по сетке 1 км',
    question:
      'Как устроено расселение Беларуси без административных границ — сеткой в один километр — с 1975 по 2020 год и куда оно идёт до 2050-го? Люди концентрируются быстрее, чем пустеет территория — но проверка независимым сенсором (ночные огни) не подтвердила совпадение направления изменений, поэтому вывод подаётся как открытый вопрос.',
    status: 'published',
    stage: 10,
    artifact: { file: 'by-maps-grid-v1.3.0.zip', version: '1.3.0', sizeKb: 18865 },
  },
  /* INF-15 END */
];
