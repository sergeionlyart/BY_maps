...
export const ARTIFACT_SEO: Record<string, ArtifactSeo> = {
  ...
  nightlights: { ru: 'Беларусь из космоса: ночная светимость районов, 1992–2075', be: 'Беларусь з космасу: начная свяцільнасць раёнаў, 1992–2075', file: 'by-maps-nightlights-v2.0.0.zip', version: '2.0.0' },
