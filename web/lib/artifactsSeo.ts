...
export const ARTIFACT_SEO: Record<string, ArtifactSeo> = {
  ...
  /* INF-13 END */
  /* INF-15 BEGIN */
  grid: { ru: 'Полотно: карта расселения Беларуси по сетке 1 км, 1975–2050', be: 'Палатно: карта расселення Беларусі па сетцы 1 км, 1975–2050', file: 'by-maps-grid-v1.1.0.zip', version: '1.1.0' },
  /* INF-15 END */
};
