  ...
  return (
    <div className="page">
      ...
      <div className="card">
        ...
        <p>
          {t('Пересчёт трёх исследовательских кандидатов H1–H3 (Минская агломерация +31,2% в уровнях, Смолевичи–Жодино −27,3% в долях, Островец +23,1% в долях) и зональная декомпозиция резидуалов по 119 зонам. Статус кейсов — «кандидат»: данные совместимы с гипотезами, причина не установлена. Гейт releaseApproved, запрет причинных формулировок, 9 контрольных метрик; воспроизводится на стандартной библиотеке.')}
        </p>
        <div className="card-foot">
          <a href="/artifacts/by-maps-nightlights-divergence-v1.0.0.zip" download>
            ⬇ by-maps-nightlights-divergence-v1.0.0.zip (217 КБ)
          </a>
        </div>
      </div>
