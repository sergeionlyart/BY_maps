...
├── code/extract/grid_project.py · grid_frames.py · grid_network.py · grid_story.py
...
└── checks/                          инварианты, ожидаемые результаты, chksums`}</code></pre>
      ...
      <pre><code>{`unzip by-maps-grid-v1.2.0.zip && cd by-maps-grid-v1.2.0
...
# Все 51 контрольных метрик воспроизведены в допусках.`}</code></pre>
