    ...
    <div className="page land">
      ...
      <section className="land-hero">
        ...
        <p className="land-lead">
          {t('Переписи 1897–2019 и оценки до 2026 года, одиннадцать исследований и прогноз до 2075-го. Каждое число сопровождается пакетом данных, кода и допущений, который можно скачать, воспроизвести и оспорить — без доверия к автору.')}
        </p>
