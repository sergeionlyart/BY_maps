  ...
  return (
    <div className="gv-root">
      ...
      <div className="gv-next" role="note">
        ...
        {t('«Страна не вымирает. Она переезжает» — читаемая статья с двадцатью иллюстрациями по этому исследованию, пятнадцать минут чтения;')}{' '}
        <a href={lang === 'be' ? '/be/article/grid' : '/article/grid'}>{t('открыть')}</a>.{' '}
