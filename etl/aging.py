...
- «лет до порога 30% доли 65+» и «естественная динамика 2019->2039» -
  ...
  рождаемость базового сценария прогноза v2026.1): показывает, где
...
# фиксированные e0 контрфакта: уровень базовой траектории v2026.1 (WPP medium)
...
def main() -> None:
    ...
    (OUT / "aging.json").write_text(json.dumps({
        ...
        "threshold": 30,
        "counterfactual": "нулевая миграция; смертность/рождаемость базового сценария v2026.1",
        "territories": out,
    }, ensure_ascii=False))
